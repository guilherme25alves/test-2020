            ...
            <div class="columns">
                ...
                >
                        ...
                        <div class="input-group">
                            <form @submit="getStudentsByFilter(filterValue)">
                                ...
                                >
                                    <i
                                        v-bind:class="
                                            getClassLoading(isLoading, 'search')
                                        "
                                    ></i>
                                </button>
                                <button
                                ...
                                >
                                    <i
                                        v-bind:class="
                                            getClassLoading(isLoading, 'clear')
                                        "
                                    ></i>
                                </button>
                            </form>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr
                                v-for="student of sortedStudents()"
                            ...
                            >
                                ...
                                <td>
                                    ...
                                    <button
                                        v-on:click="toEdit(student.student_id)"
                                        class="btn-edit btn"
                                    >
                                        Editar
                                    </button>
    ...
    methods: {
        ...
        deleteStudent(student_id) {
            this.$swal({
                ...
                text:
                    "Deletar estudante implica em perder seus dados e remover suas matrículas!",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            }).then((confirmDelete) => {
                if (confirmDelete) {
                    Students.remove(student_id)
                        ...
                        .catch(() => {
                            this.$swal(
                                "Erro ao remover Estudante! Tente novamente por gentileza!",
                                {
                                    icon: "error",
                                }
                            );
